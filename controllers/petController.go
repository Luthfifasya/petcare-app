...
func CreatePet(c *gin.Context) {
	...
	if err := database.DB.Preload("User").First(&pet, pet.ID).Error; err != nil {
...
func GetPets(c *gin.Context) {
	var pets []models.Pet
	if err := database.DB.Preload("User").Preload("Appointments").Find(&pets).Error; err != nil {
...
func GetPetByID(c *gin.Context) {
	id := c.Param("id")
	var pet models.Pet
	if err := database.DB.Preload("User").Preload("Appointments").First(&pet, id).Error; err != nil {
